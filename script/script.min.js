...
function openModal(title, objectifs) { document.getElementById("modalTitle").innerText = title; const content = document.getElementById("modalContent"); content.innerHTML = objectifs.map(obj => `<li>📌 ${obj}</li>`).join(""); document.getElementById("customModal").style.display = "flex" }
